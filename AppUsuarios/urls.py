...
from AppUsuarios.views import agregarAvatar, chatear, editarPerfil, registro, mostrar_perfiles, login_request, agregarPerfil, verPerfil, verMiPerfil, editar_mi_perfil
